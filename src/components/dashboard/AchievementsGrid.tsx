...
import { Trophy, CheckCircle, Zap, Waves, Flame, Lock } from 'lucide-react';
            ...
            >
              <div className="flex gap-4 items-center mb-4">
                ...
                <div>
                  ...
                  <span className={`text-[8px] font-black uppercase tracking-widest ${isUnlocked ? 'text-indigo-600' : 'text-slate-400'}`}>
                    {achievement.rarity}
                  </span>
                </div>
              </div>
