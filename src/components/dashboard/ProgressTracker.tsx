        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100/50 dark:border-slate-800/30">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-1.5 text-amber-500">
              ...
              <span className="text-[9px] font-medium uppercase tracking-wider text-slate-400">Streak</span>
            </div>
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-1.5 text-brand">
              ...
              <span className="text-[9px] font-medium uppercase tracking-wider text-slate-400">Focused</span>
            </div>
