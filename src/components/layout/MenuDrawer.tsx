import { BarChart3, BookOpen, Award, Settings, Crown, Moon, Sun, LogOut, Sparkles, Zap } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { useStudy } from '../../context/StudyContext';
import { storage } from '../../services/storage';
import { useEffect, useState } from 'react';

export type Section = 'dashboard' | 'subjects' | 'achievements' | 'analytics' | 'settings';
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="px-5 pt-6 pb-3 border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-brand to-violet-600 flex items-center justify-center text-white shadow-sm">
