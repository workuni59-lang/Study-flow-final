...
export const WallpaperEngine = () => {
  ...
  const renderWallpaper = () => {
    ...
    return (
      <div className={`fixed inset-0 pointer-events-none -z-20 transition-colors duration-1000 ${baseClass}`}>
        ...
        {isEnabled && (
          <>
            {/* Dynamic Focus Lens (Reactive cursor glow) */}
            <motion.div 
            ...
            {/* Soft Gradient: Immersive Corner Glows */}
  ...
  return useMemo(() => renderWallpaper(), [themeConfig.wallpaper, themeConfig.atmosphere, lensX, lensY]);
};
