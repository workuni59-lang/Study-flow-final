...
export const AUDIO_ASSETS: SoundAsset[] = [
  // ── Weather ──────────────────────────────────────────────────
  { id: 'rain', name: 'Rain', emoji: '☔️', category: 'Weather', layer: 'ambience', isPremium: false, baseVolume: 0.5, preload: true, url: `${OF}/2014/09/Rainfall-sound.mp3` },
  { id: 'light-rain', name: 'Light Rain', emoji: '🌦️', category: 'Weather', layer: 'ambience', isPremium: true, baseVolume: 0.45, preload: false, url: `${OF}/2018/11/Light-rain-sound-effect.mp3` },
  ...
  { id: 'deep-sea', name: 'Deep Sea', emoji: '🐡', category: 'Nature', layer: 'ambience', isPremium: true, baseVolume: 0.4, preload: false, url: `${OF}/2022/02/Underwater-sound.mp3` },
  ...
  { id: 'street-cafe', name: 'Street Café', emoji: '☕️', category: 'Lifestyle', layer: 'ambience', isPremium: true, baseVolume: 0.55, preload: false, url: `${OF}/2020/02/Coffee-shop-background-noise.mp3` },
  ...
  { id: 'gamma', name: 'Gamma Waves', emoji: '🙇', category: 'Focus', layer: 'music', isPremium: true, baseVolume: 0.6, preload: false, url: `${OF}/2014/11/Pink-noise.mp3` },
  { id: 'beta', name: 'Beta Waves', emoji: '👨‍💻', category: 'Focus', layer: 'music', isPremium: true, baseVolume: 0.6, preload: false, url: `${OF}/2014/11/Brown-noise.mp3` },
  { id: 'alpha', name: 'Alpha Waves', emoji: '💆', category: 'Focus', layer: 'music', isPremium: true, baseVolume: 0.6, preload: false, url: `https://orangefreesounds.com/wp-content/uploads/2023/07/Free-white-noise.mp3` },
  { id: 'theta', name: 'Theta Waves', emoji: '🧘', category: 'Focus', layer: 'music', isPremium: true, baseVolume: 0.6, preload: false, url: `${OF}/2014/11/Pink-noise.mp3` },
  { id: 'delta', name: 'Delta Waves', emoji: '😴', category: 'Focus', layer: 'music', isPremium: true, baseVolume: 0.6, preload: false, url: `${OF}/2014/11/Brown-noise.mp3` },

  // ── Niche ────────────────────────────────────────────────────
  { id: 'exam-hall', name: 'Exam Hall', emoji: '🙇', category: 'Niche', layer: 'ambience', isPremium: true, baseVolume: 0.4, preload: false, url: `https://orangefreesounds.com/wp-content/uploads/2023/04/Quiet-night-sound-effect.mp3` },
  { id: 'bowling-alley', name: 'Bowling Alley', emoji: '🎳', category: 'Niche', layer: 'ambience', isPremium: true, baseVolume: 0.5, preload: false, url: `${OF}/2020/09/Walking-through-city-park-ambience.mp3` },
