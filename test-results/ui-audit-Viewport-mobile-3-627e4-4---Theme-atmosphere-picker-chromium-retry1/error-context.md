...
- Name: ui-audit.spec.ts >> Viewport: mobile (390×844) >> a04 - Theme & atmosphere picker
- Location: ui-audit\ui-audit.spec.ts:235:5
...
Locator: getByRole('button', { name: 'Theme and atmosphere' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Theme and atmosphere' }).first()
...
- main:
  - button "Lv.1":
    - img
    - text: Lv.1
  - paragraph: Wind down or lock in — your call, Demo.
  - text: "05 : 58 PM"
  - button "Customize"
